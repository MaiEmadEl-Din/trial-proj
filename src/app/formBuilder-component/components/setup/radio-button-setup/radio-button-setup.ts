...
@Component({
  selector: 'app-radio-button-setup',
  imports: [
    CommonModule,
    ReactiveFormsModule
  ],
  templateUrl: './radio-button-setup.html',
  styleUrl: './radio-button-setup.scss'
})
export class RadioButtonSetup {
  form: FormGroup;
  ...
  selectOption(index: number) {
    this.options.controls.forEach((ctrl, i) => {
      ctrl.get('isSelected')?.setValue(i === index);
    });
  }
