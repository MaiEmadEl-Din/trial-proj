...
@Component({
  selector: 'app-conditions-acceptance-styles',
  imports: [
    CommonModule
  ],
  templateUrl: './conditions-acceptance-styles.html',
  styleUrl: './conditions-acceptance-styles.scss'
})
export class ConditionsAcceptanceStyles {
  @Input() item!: FormItem;
